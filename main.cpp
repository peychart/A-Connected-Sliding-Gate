...
String gateClosedPng= "image/png;base64,";
...
//page += "<head><meta content='text/html; charset=utf-8' http-equiv='content-type'/>\n";
  ...
  page += "<div class='value'>:&nbsp; <input name='torque' type='checkbox' " + (String)(overTorqueCheck ?"checked" :"") + " onchange='submit();' disabled></div>\n";
  page += "</form></div>\n";
  page += "</div>\n";
